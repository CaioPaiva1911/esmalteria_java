...
public class Pedidos {
	...
	private String fieldsName = "idPedido, idUsuario, dtPedido, dtPagamento, dtNotaFiscal, notaFiscal, dtEnvio, dtRecebimento, tipoFrete, rastreioFrete, entregaendereco, entregaNumero, entregaCompl, entregaBairro, entregaCidade, entregaUF, entregaCEP, entregaTelefone, entregaRefer, valorTotal, qtdItems, dtDevolucao, motivoDevolucao";
	private String keyField = "idPedido";
...
private DBQuery dbQuery = null;
	...
	public Pedidos(int idPedido, int idUsuario, String dtPedido, String dtPagamento, String dtNotaFiscal, String notaFiscal, String dtEnvio, String dtRecebimento, int tipoFrete, String rastreioFrete, String entregaendereco, String entregaNumero, String entregaCompl, String entregaBairro, String entregaCidade, String entregaUF, String entregaCEP, String entregaTelefone, String entregaRefer, double valorTotal, int qtdItems, String dtDevolucao, String motivoDevolucao) {
		...
		this.setEntregaCidade( entregaUF );
	...
	public Pedidos(String idPedido, String idUsuario, String dtPedido, String dtPagamento, String dtNotaFiscal, String notaFiscal, String dtEnvio, String dtRecebimento, String tipoFrete, String rastreioFrete, String entregaendereco, String entregaNumero, String entregaCompl, String entregaBairro, String entregaCidade, String entregaUF, String entregaCEP, String entregaTelefone, String entregaRefer, double valorTotal, String qtdItems, String dtDevolucao, String motivoDevolucao) {
		this.dbQuery = new DBQuery(this.tableName, this.fieldsName, this.keyField);
		...
		this.setDtEnvio( dtEnvio );
		this.setDtRecebimento( dtRecebimento );
		this.setTipoFrete(((tipoFrete==null)?0:Integer.valueOf(tipoFrete)));
		this.setRastreioFrete( rastreioFrete );
		this.setEntregaendereco( entregaendereco );
		this.setEntregaNumero( entregaNumero );
		this.setEntregaCompl( entregaCompl );
		...
		this.setEntregaRefer( entregaRefer );
		this.setValorTotal( valorTotal );
		this.setQtdItems(((qtdItems==null)?0:Integer.valueOf(qtdItems)));
		this.setDtDevolucao( dtDevolucao );
		this.setMotivoDevolucao( motivoDevolucao );
	}
